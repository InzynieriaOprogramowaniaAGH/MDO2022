...
Na koniec po prostu wymusiłem ustawienie hasła do konta root w kontenerze i dzięki temu udało mi się połaczyć z nim przez ssh. Klucze dalej nie działają.
...
UPDATE
Po połączeniu się ze stacjonarnym internetem zamiast HotSpotem z Ksiajomi projekt udało się zbudować a testy zakończyły się powodzeniem.
